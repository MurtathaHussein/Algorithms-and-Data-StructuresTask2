...
namespace Week5TaskA
{
    ...
    internal class Graph
    {
        ...
        public int NumOfNodes()
        {
            ...
            // TO BE COMPLETED
            //count and return the number of the elements within the list of nodes
            NumOfNodesone = NumOfNodesone + 1;
            return NumOfNodesone;
        }
        ...
        public int NumOfEdges()
        {
            ...
            // There are two main ways to do it (one easier than the other one):
            NumOfEdgessone = NumOfEdgessone + 1;
            return NumOfEdgessone;
